...
<form name = "login form" method = "Post" action = "addTrainer">
...
%>
  ...
  <input type="date" id="DateOfJoining" name="DateOfJoining" value ="<%=((action.equals("updateTrainer")) ? employee.getDateOfJoining() : "" )%>" required><br><br>
